  ...
  return (
    ...
    <div className="w-full h-screen bg-black flex items-end md:items-center lg:items-end flex-col">
      ...
      <div className="flex-0  w-full h-6/10 md:w-7/10 md:h-[65%] md:relative md:right-0 content-center lg:right-20">
        <img src="pro.png" className="w-full h-full object-cover top-[100%]"/>/
        {/* <p className="absolute md:left-2 md:text-md lg:top-[36%] lg:left-[-20%] left-2 top-[20%] text-white text-[8px] lg:text-xl md:top-[40%]">[USER PROMPT]</p> */}
      </div>
