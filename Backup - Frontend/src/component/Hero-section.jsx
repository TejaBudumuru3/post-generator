...
const Hero = () => {
            ...
            if (mountAnimationProgress < animationDuration) {
                ...
                grids.forEach((grid, i) => {
                    ...
                    if (totalProgress > revealDelay) {
                        ...
                        grid.material.opacity = easedProgress * (0.3 - i * 0.07);
    ...
    return (
        <>
            ...
            <section className="h-screen w-screen flex justify-center items-center text-center font-['Exo_2'] text-white relative">
